...
export default function Register({ submitted }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      {/* Card */}
      <div className="relative w-full max-w-md bg-white shadow-lg rounded-lg px-6 pt-12 pb-4 mt-16 mb-4 animate-fade-in-up transition-all duration-300 hover:scale-[1.01]">
