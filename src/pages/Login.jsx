    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="grid md:grid-cols-2 gap-10 max-w-5xl w-full items-center">
        ...
        <div className="hidden md:block animate-fade-in-left">
          ...
          <div
            className="relative cursor-pointer transform scale-90 transition-all duration-900 delay-200
             hover:scale-105 hover:rotate-2 hover:brightness-110 hover:shadow-[0_10px_20px_rgba(99,102,241,0.4)]"
